...
enum Commands {
    ...
    Diff {
        ...
        /// Diff stream layout: `unified` (default), `stack`, `split`, or `auto`.
    ...
    Show {
        ...
        #[arg(long, value_parser = parse_export_on_quit_arg)]
        export_on_quit: Option<ExportOnQuit>,
        /// Diff stream layout: `unified`, `stack`, `split`, or `auto`.
        #[arg(long, value_parser = parse_layout_arg)]
        layout: Option<LayoutMode>,
...
/// clap value_parser for `--layout`. Accepts unified|stack|split|auto (case-insensitive).
